...
Version  : 7.0.0
Release  : 9
URL      : https://github.com/dylanaraps/neofetch/archive/7.0.0/neofetch-7.0.0.tar.gz
Source0  : https://github.com/dylanaraps/neofetch/archive/7.0.0/neofetch-7.0.0.tar.gz
...
%prep
%setup -q -n neofetch-7.0.0
cd %{_builddir}/neofetch-7.0.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585086758
...
cp %{_builddir}/neofetch-7.0.0/LICENSE.md %{buildroot}/usr/share/package-licenses/neofetch/e79c0e7c09652ab87c5121d97f515d8b49ab3067
%make_install
